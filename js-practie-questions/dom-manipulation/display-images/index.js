      let blogs = [
        ...
        {
          title:
            "Graphic Designing Training in Putalisadak, Kathmandu | Mindrisers",
          image:
      ...
      blogs.forEach((el) => {
        ...
        <img src="https://mindrisers.com.np${el.image}"/>
        `;
      });

      // document.getElementById("images").innerHTML = `
      // <img  src="https://mindrisers.com.np/static/Images/blog/single_post/Web_Designing_Training_in_Putalisadak_Kathmandu.jpg"/>
      // <img  src="https://mindrisers.com.np/static/Images/blog/single_post/DevOps_Training_in_Putalisadak_Kathmandu__Mindrisers.png"/>
      // `
