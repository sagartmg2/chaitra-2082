...
console.log(students[2].scores[0].gpa);
console.log(students[2].scores[1].gpa);

console.log(`${students[2].name} scored gpa ${students[2].scores[0].gpa} in first-term and ${students[2].scores[1].gpa} in second-term`)
